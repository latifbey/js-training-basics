...
// 12
{
  var c = 1;
  var a = "1";
  var processed = +a+c;  //   (+c + +a;)       correct this! check js Number Object
...
// 13
{
  var c = 1;
  var a = 1;
  var processed = ""+ c + a;  // bir tane bos string islemi tamamen stringle yapistirma toplama yaptirir correct this!
...
{
  var a = "it"
  var processed = a.concat("mlub");  // split stringi arraya donusturur. correct this!
  processed=processed.split('');  // string teki elemanlar yapisik oldugundan split ile ayirir istedigimiz degisikligi yapar sonra join ile tekrar arrayi birlestirip stringe donustutruruz.
    processed[2]='c';
    processed=processed.join('');//join de splitin tersi arrayi stringe donusturur
  check(a, 'it');
  isEqual('itclub', processed);
}
// 19//////////////////////////////////////////////////
...
// 20
{
  var c = "itclub";
  var b = "lub";
  var processed =c.substring(3,6);/////substr ve substring ile 2 farkli cozum  
      //c.substr(3,3); // correct this!
...
// 23
{
  var c = ["it", "club","abc", "schweiz"]; // correct this!
  isEqual(4, c.length);
}
// 24
{
  ...
  var processed = c; // correct this! check array functions
    //c[0]="ABC";             /////// c[0] ile atayabiliriz. ayni zamanda unshift ile de onden ekleyebiliriz
    c.unshift("ABC");
  isEqual(c[0], "ABC");
}
// 25
